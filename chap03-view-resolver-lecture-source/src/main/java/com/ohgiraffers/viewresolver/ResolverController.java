...
public class ResolverController {
    ...
    public String stringReturning(Model model) {
        ...
        *   ThymeleafViewResolver 에게 앞에 resource/template 붙이고
    ...
    public String stringRedirectReturning(Model model) {

        /* 접두사로 redirect: 을 하면 forward 방식이 아닌 redirect 를 시켜준다. */
        return "redirect:/";
    }
    ...
    *  */
    ...
    public ModelAndView modelAndViewRedirect(ModelAndView mv,RedirectAttributes  rttr) {
        ...
        rttr.addFlashAttribute("flashMessage2",
                "ModelAndView 를 이용한 redirect attr");
        mv.setViewName("redirect:/");
        return mv;
    }
